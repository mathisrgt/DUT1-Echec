...
public class Plateau {
    ...
    {
        if (origine.coordonneesReverse().compareTo("e1") == 0)
        {
            if (destination.coordonneesReverse().compareTo("g1") == 0)
            {
                echiquier[tailleLigne - 1][5] = echiquier[tailleLigne - 1][7];
                echiquier[tailleLigne - 1][7] = null;
            }
            else if (destination.coordonneesReverse().compareTo("c1") == 0)
            {
                echiquier[tailleLigne - 1][3] = echiquier[7][0];
                echiquier[tailleLigne - 1][0] = null;
            }    
        }
        else if (origine.coordonneesReverse().compareTo("e8") == 0)
        {
            if (destination.coordonneesReverse().compareTo("g8") == 0)
            {
                echiquier[0][5] = echiquier[0][7];
                echiquier[0][7] = null;
            }
            else if (destination.coordonneesReverse().compareTo("c8") == 0)
            {
    ...
    {  
        ...
        if (origine.coordonneesReverse().compareTo("e8") == 0)
        {
            roque.desactivePetitRoqueNoir();
            roque.desactivePetitRoqueNoir();
        }

        if (origine.coordonneesReverse().compareTo("a1") == 0)
        {
           roque.desactiveGrandRoqueBlanc();
        }

        if (origine.coordonneesReverse().compareTo("a8") == 0)
        {
            roque.desactiveGrandRoqueNoir();
        }

        if (origine.coordonneesReverse().compareTo("h1") == 0)
        {
            roque.desactivePetitRoqueBlanc();
        }

        if (origine.coordonneesReverse().compareTo("h8") == 0)
        {
            roque.desactivePetitRoqueNoir();
        }
    }
    ...
    public String getHelp()
    {
        ...
        for (DeplacementsParPiece piece : listeTousDeplacements)
        {
            ...
            listeDeplacement.append(" en " + Couleur.getVert() +  piece.getCoord().coordonneesReverse() + Couleur.getStopCouleur() + " peut se déplacer en : \n");
    ...
    public String toString()
    {
        ...
        for (int nomLigne = tailleLigne; nomLigne > 0; nomLigne--)  //Ligne du tableau
        {
            ...
            for (int idxColonne = 0; idxColonne < tailleColonne; idxColonne++) 
            {
                ...
                {
                    if (echiquier[idxLigne][idxColonne].getCouleur() == CouleurPiece.BLANC)
                        str.append(Couleur.getJaune());
                    else
                        str.append(Couleur.getBleu());
                    str.append(echiquier[idxLigne][idxColonne].getNom());
                    str.append(Couleur.getStopCouleur());
                }
                else   
                    str.append(" ");
            }
