...
public class FabriqueJoueur {
    ...
    {
        System.out.println("Quelle couleur voulez-vous jouer ?\n" + Couleur.getVert() + "b" + Couleur.getStopCouleur() +
        " -> jouer les blancs\n" + Couleur.getVert() + "n" + Couleur.getStopCouleur() + " -> jouer les noirs");
        ...
        //Continue tant que l'utilisateur n'a pas choisie une couleur correcte.
        {
            ...
            {
                case 'b' :
                    System.out.print("Vous jouez les " + Couleur.getVert() + "blancs" + Couleur.getStopCouleur());
                    return CouleurPiece.BLANC;
                case 'n' :
                    System.out.print("Vous jouez les " + Couleur.getVert() + "noirs" + Couleur.getStopCouleur());
