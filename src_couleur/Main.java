...
public class Main {
    ...
    private static boolean rejouer(Scan scanner)
    {
        ...
        " -> Rejouer\n" + Couleur.getVert() + "non" + Couleur.getStopCouleur() + " -> Fin du jeu\n";
        ...
        System.out.println("\nFin de la session de jeu." + Couleur.getVert() + " Merci" + Couleur.getStopCouleur() + " d'avoir joué !\n");
        return false;
    }
    ...
    {
        if (reponse.compareTo("oui") == 0 || reponse.compareTo("non") == 0)
            return true;
        return false;    
    }
