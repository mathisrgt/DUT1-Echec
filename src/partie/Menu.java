...
public class Menu
{
    ...
    public ModeDeJeu choixModeDeJeu()
    {
        ...
        System.out.println("\nMode choisi : " + affichageChoix(modeDeJeu));
    ...
    private String listeModeDeJeu()
    {
        ...
        str.append("Choisissez le mode de jeu :\n\n" ); 
        str.append("1 -> Joueur contre Joueur\n");
        str.append("2 -> Joueur contre Ordinateur (hasard)\n"); 
        str.append("3 -> Ordinateur contre Ordinateur (hasard)\n"); 
        str.append("4 -> Joueur contre Joueur (mode Roi/Tour)");   
